...
UIKIT_EXTERN const CGFloat MJRefreshLeadWidth;
...
UIKIT_EXTERN NSString *const MJRefreshLeaderIdleText;
UIKIT_EXTERN NSString *const MJRefreshLeaderPullingText;
